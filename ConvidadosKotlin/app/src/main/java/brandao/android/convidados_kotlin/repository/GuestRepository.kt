...
class GuestRepository private constructor(context: Context) {
    ...
    fun update(guest: GuestModel): Boolean {
        ...
        return try {
            ...
            //Passando o id que deve ser procurado para atualizar
    ...
    fun getPresent(): List<GuestModel> {
        ...
        try {
           ...
           /* val id = DataBaseConstants.GUEST.COLUMNS.ID
            ...
            val preserce = DataBaseConstants.GUEST.COLUMNS.PRESENCE
            val Guest = DataBaseConstants.GUEST.TABLE_NAME*/

           // val sql = "SELECT $id, $name, $preserce FROM $Guest WHERE $preserce = 1"
